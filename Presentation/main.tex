...
\title{Presentaci\'on de Miner\'ia de datos \\ \'Exitos de Spotify}
...
\begin{frame}{Fase II: Comprensión de los Datos}
    \textbf{Origen del Dataset:} Spotify Tracks Dataset \href{https://www.kaggle.com/datasets/maharshipandya/-spotify-tracks-dataset}{(Kaggle)}.
    \begin{itemize}
        \item \textbf{Volumen:} Aproximadamente 114,000 registros.
        \item \textbf{Variables:} 21 características (numéricas, categóricas y booleanas).
    \end{itemize}
    ...
    \begin{table}[]
        ...
        \begin{tabular}{|l|l|}
        \hline
        \textbf{Tipo de Variable} & \textbf{Ejemplos} \\ \hline
        Metadatos & \texttt{track\_id}, \texttt{artists}, \texttt{album\_name} \\ \hline
        Acústicas (Predictoras) & \texttt{danceability}, \texttt{energy}, \texttt{loudness}, \texttt{tempo} \\ \hline
        Objetivo (Target) & \texttt{popularity} \\ \hline
        \end{tabular}}
        \caption{Estructura simplificada del dataset escogido.}
    \end{table}
\end{frame}
